...
namespace VRC.Internal.Generated
{
    ...
    public class EmptyStruct_05BF : ValueType
    {
        public int ÎÌÌÍÌÏÍÎÏÌÌÍÌÌÏÏÏÏÌÎÍÎÍ; // 0x10
        public int ÏÏÌÏÎÌÍÏÎÌÎÌÍÌÎÎÍÏÌÍÏÌÌ; // 0x14
    }

    /// <summary>Originally: ÌÏÌÌÎÏÏÎÍÌÎÏÌÍÏÏÎÌÏÎÌÏÌ</summary>
    public class EmptyStruct_0667 : ValueType
    {
        public ÍÎÎÏÍÍÌÍÎÎÍÍÏÌÎÏÎÌÏÏÌÎÌ ÌÏÎÏÍÌÌÏÌÏÍÌÍÎÍÎÏÍÏÌÌÍÌ; // 0x10
    ...
    {
        public int ÏÏÏÏÏÌÏÌÍÏÌÎÍÏÍÍÎÌÍÍÍÌÍ; // 0x10
    ...
    public class EmptyStruct_0C48 : ValueType
    {
        public ÌÏÌÏÏÏÎÌÍÌÍÍÌÌÌÍÌÌÌÎÍÍÍ ÎÏÌÍÎÎÎÍÍÏÎÍÍÏÌÍÍÏÎÌÎÎÌ; // 0x10
        public System.Collections.Generic.IList`1<ÌÏÌÏÏÏÎÌÍÌÍÍÌÌÌÍÌÌÌÎÍÍÍ> ÏÏÍÍÏÎÌÍÏÏÍÎÎÍÌÎÍÍÏÍÌÎÎ; // 0x18
        public ÌÎÌÏÍÌÎÌÎÌÎÎÏÏÍÌÌÎÎÌÏÌÎ ÍÌÎÎÎÎÎÏÏÌÏÌÌÎÍÍÎÎÎÏÍÍÎ; // 0x20
    ...
    public class EmptyStruct_0EE8 : ValueType
    {
        ...
        public int ÍÍÍÏÍÌÏÎÏÏÍÎÏÎÍÎÌÏÌÏÍÌÏ; // 0x4C
    }

    /// <summary>Originally: ÌÌÍÎÌÌÌÍÏÏÌÏÏÌÏÎÍÍÍÌÏÎÎ</summary>
    public class EmptyStruct_14A6 : ValueType
    {
        public int ÌÏÏÍÍÎÎÌÎÍÌÍÎÌÎÌÏÌÏÌÏÎÎ; // 0x10
    ...
    public class EmptyStruct_2885 : ValueType
    {
        ...
        public string ÍÏÍÏÏÌÍÎÍÏÍÏÎÍÍÍÎÍÎÌÎÍÌ; // 0x20
    ...
    public class EmptyStruct_2B6A : ValueType
    {
        public byte[] ÎÌÎÍÏÌÌÍÎÎÎÎÌÏÏÎÌÌÏÍÎÎÏ; // 0x10
        public int ÎÍÌÌÎÏÍÎÌÏÌÎÎÌÎÌÌÌÏÌÏÍÌ; // 0x18
    ...
    public class EmptyStruct_2FF0 : ValueType
    {
        ...
        public VRC.Localization.LocalizableString ÌÍÍÌÏÍÌÌÏÌÏÍÏÍÎÏÏÍÍÌÌÍÍ; // 0x60
        public VRC.Localization.LocalizableString ÍÍÍÎÎÎÏÏÏÎÌÏÎÍÍÍÍÏÍÏÌÏÌ; // 0x88
        public VRC.Localization.LocalizableString ÌÎÎÏÍÎÍÍÌÍÌÏÏÏÍÍÌÏÌÍÍÌÍ; // 0xB0
        public VRC.Localization.LocalizableString ÏÎÍÍÎÌÏÍÎÎÍÌÏÎÍÌÌÍÍÌÎÌÏ; // 0xD8
    ...
    public class EmptyStruct_3D28 : ValueType
    {
        public VRC.Core.ApiWorldInstance ÍÏÍÎÍÎÍÎÌÎÏÌÎÍÎÏÏÍÌÏÌÍÏ; // 0x10
    }

    /// <summary>Originally: ÌÏÏÏÌÌÍÍÎÎÏÌÍÎÎÍÏÎÏÍÍÏÎ</summary>
    public class EmptyStruct_3E98 : ValueType
    {
        public bool ÌÍÏÌÏÍÌÏÎÍÌÍÍÎÏÏÌÏÍÍÏÏÌ; // 0x10
        public float ÍÏÎÍÎÏÌÍÍÌÏÍÍÌÌÌÎÏÎÏÍÎÍ; // 0x14
        public float ÍÌÌÏÏÏÍÍÏÏÎÍÍÍÍÍÌÏÌÍÍÍÌ; // 0x18
        public float ÏÏÌÏÌÍÏÍÍÍÌÏÏÍÎÍÌÍÌÍÏÌÏ; // 0x1C
        public float ÍÏÌÍÏÏÌÍÌÏÍÍÎÏÍÏÏÍÎÌÏÌÎ; // 0x20
    }

    /// <summary>Originally: ÌÌÎÎÎÍÏÎÌÍÎÏÏÌÌÌÌÌÏÌÌÏÏ</summary>
    public class EmptyStruct_3F04 : ValueType
    {
        public UnityEngine.SkinnedMeshRenderer ÍÎÏÏÎÏÎÌÎÍÌÏÍÌÌÏÎÎÍÌÎÍÏ; // 0x10
        public UnityEngine.SkinnedMeshRenderer ÏÎÎÏÎÌÌÏÌÌÎÍÌÎÏÎÎÎÏÌÌÎÍ; // 0x18
        public int ÍÍÍÏÍÌÏÎÏÏÍÎÏÎÍÎÌÏÌÏÍÌÏ; // 0x20
    }

    /// <summary>Originally: ÍÍÍÏÎÍÌÎÏÌÌÏÍÎÍÏÍÌÏÌÌÎÍ</summary>
    public class EmptyStruct_3F1B : ValueType
    {
        public ÏÏÍÎÍÍÎÌÍÍÍÍÎÌÏÎÍÎÎÏÍÍÍ ÍÌÍÌÍÎÎÌÍÍÏÏÏÏÌÍÌÍÍÎÎÎÍ; // 0x10
        public string ÍÎÎÌÏÏÎÌÌÌÌÏÏÏÍÌÎÍÏÌÏÏÍ; // 0x18
        public string ÌÌÎÌÎÌÏÎÌÌÏÍÍÏÌÎÍÎÏÏÎÎÍ; // 0x20
        public int ÏÎÍÎÍÍÏÍÍÍÎÌÏÎÎÎÌÎÌÏÎÍÏ; // 0x28
        public UnityEngine.Vector3 ÏÎÍÏÌÌÍÏÍÎÍÌÎÌÏÌÌÍÌÌÍÎÌ; // 0x2C
        public UnityEngine.Quaternion ÌÎÎÏÍÍÏÎÎÌÎÌÌÎÎÎÍÎÍÏÏÏÍ; // 0x38
        public float ÍÍÍÌÍÌÌÍÍÎÍÏÌÎÎÎÎÍÎÌÍÎÌ; // 0x48
    ...
    {
        public bool ÎÌÎÌÎÍÎÍÌÍÍÌÏÎÍÍÌÏÏÍÏÌÏ; // 0x10
        public bool ÎÌÌÌÎÏÌÌÌÏÎÎÏÍÏÎÏÌÏÌÎÎÌ; // 0x11
        public bool ÏÏÌÎÍÎÎÎÎÌÏÏÏÌÍÍÌÍÎÍÎÎÏ; // 0x12
        public bool ÏÍÍÏÏÌÎÎÌÏÍÌÌÏÎÍÌÌÍÎÏÌÎ; // 0x13
        public bool ÍÌÍÏÌÌÌÎÎÏÎÏÎÍÌÏÎÌÌÍÍÎÌ; // 0x14
        public bool ÏÏÏÌÍÌÏÎÍÏÎÌÍÍÏÏÏÎÌÏÍÌÌ; // 0x15
        public bool ÍÏÏÌÍÌÎÎÎÎÏÌÌÏÏÌÎÎÌÍÎÎÍ; // 0x16
        public bool ÏÎÌÏÎÌÏÍÌÌÍÌÎÍÏÍÎÍÍÎÎÍÌ; // 0x17
    ...
    /// <summary>Originally: ÌÍÍÏÎÎÌÏÍÍÎÎÏÏÌÎÎÍÏÌÌÎÍ</summary>
    public class EmptyStruct_578B : ValueType
    {
    ...
    public class EmptyStruct_5D6E : ValueType
    {
        public UnityEngine.Vector3 ÏÏÍÍÍÎÌÌÍÏÎÌÏÎÍÌÍÌÏÎÍÏÍ; // 0x10
        public UnityEngine.Vector3 ÌÏÏÍÍÌÏÍÏÏÌÏÏÏÏÍÌÌÏÏÌÏÎ; // 0x1C
        public UnityEngine.Vector3 ÎÏÏÍÍÍÌÏÏÏÎÎÌÎÏÏÍÏÌÌÌÍÍ; // 0x28
    ...
    public class EmptyStruct_6E93 : ValueType
    {
    ...
    {
        public object ÎÌÎÍÏÌÌÍÎÎÎÎÌÏÏÎÌÌÏÍÎÎÏ; // 0x10
    ...
    public class EmptyStruct_8B79 : ValueType
    {
    ...
    public class EmptyStruct_8FFE : ValueType
    {
    ...
    public class EmptyStruct_94E4 : ValueType
    {
        public float ÌÏÌÏÍÌÏÏÍÏÍÌÎÍÍÏÌÎÏÍÍÌÏ; // 0x10
    }

    /// <summary>Originally: ÌÎÌÌÎÌÏÍÌÌÍÍÌÍÍÌÎÏÍÏÏÎÌ</summary>
    public class EmptyStruct_9FD7 : ValueType
    {
        public string ÍÏÌÎÏÍÌÌÎÌÎÎÍÍÎÎÏÎÎÌÏÎÌ; // 0x10
    ...
    public class EmptyStruct_B3CB : ValueType
    {
        public UnityEngine.Renderer ÏÎÏÍÏÌÌÎÏÍÍÏÌÌÎÍÍÌÍÎÍÍÌ; // 0x10
    ...
    public class EmptyStruct_B6B8 : ValueType
    {
        public ÌÌÍÎÎÌÌÌÌÍÍÏÌÍÍÎÍÏÌÏÏÌÏ ÌÏÎÏÍÌÌÏÌÏÍÌÍÎÍÎÏÍÏÌÌÍÌ; // 0x10
        public VRC.SDK3.Components.VRCSceneDescriptor ÏÎÏÏÎÍÏÎÏÍÌÏÍÎÍÏÏÎÌÎÎÌÏ; // 0x18
        public System.Collections.Generic.List`1<UnityEngine.GameObject> ÍÌÎÎÏÍÍÎÎÍÏÏÌÍÌÏÍÍÎÎÍÌÌ; // 0x20
    }

    /// <summary>Originally: ÌÎÎÏÏÍÏÍÎÏÎÍÌÎÌÏÎÎÎÌÍÍÏ</summary>
    public class EmptyStruct_B78E : ValueType
    {
    ...
    public class EmptyStruct_BEF4 : ValueType
    {
        public UnityEngine.Vector2 ÎÎÏÌÍÎÏÏÎÎÌÌÌÏÎÎÏÏÎÏÌÏÎ; // 0x10
        public UnityEngine.Vector2 ÍÏÍÌÌÎÎÎÌÍÌÏÍÍÏÌÎÍÏÏÍÎÎ; // 0x18
        public UnityEngine.Vector2 ÎÌÎÌÍÎÎÏÏÌÎÎÏÎÏÏÎÎÍÍÌÏÎ; // 0x20
        public UnityEngine.Vector2 ÎÎÌÎÎÏÍÌÎÏÏÏÎÎÍÍÎÏÎÌÌÌÍ; // 0x28
        public UnityEngine.Vector2 ÍÎÏÎÌÏÏÍÌÍÍÎÌÎÎÌÍÏÎÌÎÎÏ; // 0x30
        public float ÏÎÍÎÌÌÏÌÎÏÏÍÍÏÍÏÍÌÎÍÎÌÌ; // 0x38
        public float ÏÎÌÍÍÏÏÌÎÎÌÌÌÌÎÎÍÌÏÍÌÌÏ; // 0x3C
        public float ÍÎÎÌÌÏÍÍÎÏÌÎÍÍÍÌÌÌÍÏÍÍÌ; // 0x40
    ...
    public class EmptyStruct_C8E7 : ValueType
    {
    ...
    public class EmptyStruct_D0F9 : ValueType
    {
    ...
    public class EmptyStruct_D8CC : ValueType
    {
        public UnityEngine.Transform ÏÏÎÏÍÌÎÏÎÏÎÎÍÌÍÏÍÎÎÎÍÏÌ; // 0x10
        public ÏÌÎÎÍÎÌÍÍÌÍÌÏÏÌÏÌÎÌÍÎÎÏ ÌÏÎÏÍÌÌÏÌÏÍÌÍÎÍÎÏÍÏÌÌÍÌ; // 0x18
    }
    ...
    public class EmptyStruct_DC31 : ValueType
    {
        public ÌÌÏÌÏÏÍÏÍÌÎÎÌÌÏÌÌÍÍÌÍÏÌ ÏÏÏÏÎÍÌÌÌÎÍÏÏÍÏÌÍÍÌÏÍÎÍ; // 0x10
        public ÌÍÌÏÍÌÍÍÏÌÏÏÍÍÎÎÏÌÌÍÌÎÎ ÏÏÏÍÏÎÏÎÎÏÍÍÎÌÎÎÍÍÎÎÎÎÎ; // 0x18
        public UnityEngine.UI.Button ÏÍÍÌÏÍÍÎÌÌÏÍÎÍÎÏÎÏÏÏÌÌÌ; // 0x20
    ...
    public class EmptyStruct_DE37 : ValueType
    {
    ...
    public class EmptyStruct_E632 : ValueType
    {
        public ÌÏÌÏÏÏÎÌÍÌÍÍÌÌÌÍÌÌÌÎÍÍÍ ÌÎÌÍÎÎÍÌÌÍÍÏÏÌÏÌÍÎÌÎÏÌÍ; // 0x10
        public int ÍÎÍÎÌÎÏÏÎÌÏÎÎÌÌÌÍÏÎÏÍÌÏ; // 0x18
        public bool ÍÎÎÍÏÍÌÍÍÎÎÏÌÏÏÎÌÌÏÌÏÏÏ; // 0x1C
        public ÌÎÌÏÍÌÎÌÎÌÎÎÏÏÍÌÌÎÎÌÏÌÎ ÍÌÌÍÌÎÎÎÏÏÍÍÌÎÌÍÌÌÍÌÌÏÌ; // 0x20
        public ÍÎÏÎÌÌÌÎÍÏÎÌÏÎÍÏÌÏÏÌÎÍÌ ÌÌÏÌÎÎÌÌÏÏÍÍÎÎÍÍÏÎÍÏÌÎÌ; // 0x28
        public ÍÎÏÎÌÌÌÎÍÏÎÌÏÎÍÏÌÏÏÌÎÍÌ ÌÍÎÏÌÏÍÏÍÏÎÌÏÍÌÏÌÎÎÎÍÌÏ; // 0x30
        public ÎÏÌÏÏÎÍÏÍÌÏÏÍÌÏÌÍÎÍÌÌÏÌ ÍÎÎÍÌÍÎÍÌÎÌÎÎÍÏÎÍÌÎÎÌÎÌ; // 0x38
    }

    /// <summary>Originally: ÍÌÍÎÌÎÎÌÏÌÌÌÎÌÌÎÏÌÎÎÏÏÌ</summary>
    public class EmptyStruct_ED98 : ValueType
    {
        public int ÍÍÍÍÏÌÏÌÎÌÏÍÎÎÎÌÌÌÏÏÍÌÏ; // 0x10
        public uint ÏÌÎÌÌÍÌÏÎÍÌÌÌÏÍÎÌÌÎÌÌÌÎ; // 0x14
    ...
    public class EmptyStruct_EE86 : ValueType
    {
        ...
        public System.Action ÍÏÍÍÎÌÎÍÏÎÎÏÌÍÌÍÌÌÍÎÎÎÎ; // 0x20
        public System.Action`1<int> ÎÌÌÍÏÎÏÍÎÍÍÏÏÏÍÌÎÍÎÌÎÏÍ; // 0x28
        public System.Collections.Generic.List`1<VRC.Localization.LocalizableOptionData> ÍÍÍÎÏÎÎÌÏÎÍÌÎÏÎÏÌÍÎÏÍÎÌ; // 0x30
        public UnityEngine.Sprite ÌÌÏÎÍÎÏÍÌÎÍÎÏÎÌÎÍÎÎÎÎÍÌ; // 0x38
        public VRC.Localization.LocalizableString ÏÍÏÍÎÏÌÏÍÏÏÏÍÏÎÎÌÍÏÍÎÏÍ; // 0x40
        public VRC.Localization.LocalizableString ÏÏÍÎÌÎÌÍÏÏÎÌÎÌÏÌÍÎÌÌÏÌÌ; // 0x68
    ...
    public class EmptyStruct_FA19 : ValueType
    {
    ...
    public class EmptyStruct_FE31 : ValueType
    {
        ...
        public float ÌÍÍÎÌÍÎÏÎÏÌÍÏÍÎÍÎÍÍÌÎÎÍ; // 0x1C
    ...
    /// <summary>Originally: ÌÏÎÏÌÏÌÌÍÌÍÎÎÎÌÏÏÏÏÎÍÍÍ</summary>
    public class EmptyType_58FC
    {
    }
    ...
    /// <summary>Originally: ÍÍÌÎÏÍÍÏÏÏÎÏÍÍÌÌÎÍÌÍÍÍÏ</summary>
    public class EmptyType_E56A
    {
    }

    /// <summary>Originally: ÌÏÎÎÏÏÏÎÏÎÎÏÏÍÏÎÏÍÎÍÎÏÍ</summary>
    public class EmptyType_ECE8
    {
    }
