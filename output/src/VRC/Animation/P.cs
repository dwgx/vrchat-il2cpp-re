...
namespace VRC.Animation
{
    ...
    public class ProcessRootMotionProcessAnimation_A84E : ValueType
    {
        ...
        public Unity.Collections.NativeArray`1<float> ÏÎÌÏÌÌÎÎÌÎÍÌÏÎÎÏÏÌÏÌÌÎÌ; // 0x30
        public Unity.Collections.NativeArray`1<float> ÏÍÎÏÌÏÏÍÎÎÍÏÌÎÌÎÌÌÎÌÏÍÍ; // 0x40
        public Unity.Collections.NativeArray`1<UnityEngine.Animations.MuscleHandle> ÍÌÎÏÍÎÌÎÎÍÍÏÎÏÏÌÏÎÎÎÎÌÍ; // 0x50
        public Unity.Collections.NativeArray`1<int> ÎÌÌÏÌÏÌÏÏÎÍÏÌÌÏÌÍÍÎÍÌÍÏ; // 0x60
        public Unity.Collections.NativeArray`1<int> ÍÍÏÎÏÎÌÍÏÌÏÍÎÍÎÎÏÏÎÍÏÍÏ; // 0x70
        public Unity.Collections.NativeArray`1<int> ÏÍÏÎÏÎÌÌÌÏÏÌÎÎÍÎÎÏÏÎÎÏÏ; // 0x80
        public bool ÍÍÍÍÎÏÍÌÍÎÎÌÍÍÍÌÎÏÍÏÏÏÌ; // 0x90
        public bool ÏÎÏÍÏÏÏÎÎÎÎÏÏÏÏÍÏÍÎÎÎÍÎ; // 0x91
        public bool ÍÍÏÍÎÌÌÎÍÏÍÍÌÎÎÌÎÎÍÏÏÎÍ; // 0x92
        public bool ÍÎÎÍÎÍÏÌÌÏÌÎÎÍÎÎÏÏÌÌÎÎÍ; // 0x93
        public bool ÎÏÍÎÌÌÍÌÏÌÏÎÍÍÎÍÎÍÎÌÌÍÍ; // 0x94
