...
namespace ThirdParty.Other.Unity.IO.LowLevel.Unsafe
{
    public class AsyncReadManagerMetricsFilters[] : Array
    {
        // ── Methods ──
    ...
    public class AsyncReadManagerRequestMetric[] : Array
    {
        // ── Methods ──
