...
namespace ThirdParty.Valve.Valve.VR.InteractionSystem
{
    ...
    {
        public BuffersImpl _emailCaptureView; // 0x20
        public BuffersImpl _emailInstructionsView; // 0x28
        public BuffersImpl _errorView; // 0x30
        public ePathName117.? _nextButton; // 0x38
        public ePathName117.? _cancelButton; // 0x40
        public ePathName117.? _dismissButton; // 0x48
        public ePathName117.? _errorDismissButton; // 0x50
        public ÍÏÌ _emailInputField; // 0x58
        public ÍÍÏÌÎÎÎÌÍÍÍÎÍÏÎÌÍÏÏ>k__BackingField _marketingToggle; // 0x60
        public ÍÏÎÍÌÍÌÎÌÏÌÍÏÍÌÏÎÎÎÎÏÏ _emailText; // 0x68
        public ÍÏÎÍÌÍÌÎÌÏÌÍÏÍÌÏÎÎÎÎÏÏ _errorText; // 0x70
        public SAAButton ÏÎÎÏÎÏÌÏÍÌÌÍÎÍÍÏÏÏÎÌÍÌÌ; // 0x78
        public string ÍÎÏÍÏÎÏÌÎÌÌÏÏÍÌÍÍÌÌÍÍÏÌ; // 0x80
        public bool ÌÌÍÎÍÏÍÌÏÎÎÏÌÎÏÎÏÍÌÍÍÌÏ; // 0x88
