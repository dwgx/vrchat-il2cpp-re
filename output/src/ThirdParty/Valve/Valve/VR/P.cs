...
namespace ThirdParty.Valve.Valve.VR
{
    ...
    {
        public 0x6B2400D8 prop; // 0x10
        public 0x6B241838 writeType; // 0x14
        public 0x6B240130 eSetError; // 0x18
        public UIntPtr pvBuffer; // 0x20
        public uint unBufferSize; // 0x28
        public uint unTag; // 0x2C
        public 0x6B240130 eError; // 0x30
