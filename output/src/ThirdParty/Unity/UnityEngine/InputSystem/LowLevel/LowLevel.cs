...
namespace ThirdParty.Unity.UnityEngine.InputSystem.LowLevel
{
    ...
    {
        public float typeStatic; // 0x20
        public float ÌÍÎÌÍÏÎÎÌÍÍÎÌÌÌÎÏÏÍÌÎÍÌ; // 0x24
        public float ÎÏÎÍÏÌÎÌÎÏÎÏÍÌÎÎÏÏÌÎÌÎÏ; // 0x28
        public object ÌÍÌÎÏÎÎÏÏÏÏÍÌÍÌÍÎÌÍÍÏÌÌ; // 0x2C
        public BuffersImpl ÏÌÌÌÌÎÏÏÍÏÍÏÍÏÎÌÎÏÏÍÌÌÌ; // 0x30
        public BuffersImpl ÌÌÎÎÎÍÌÌÏÏÏÏÎÍÎÍÏÎÎÎÏÍÎ; // 0x38
        public ÍÎÌÍÍÌÌÎÏÏ ÌÍÍÍÍÎÍÍÎÍÏÌÍÌÍÍÍÎÍÌÍÏÎ; // 0x40
        public float ÍÍÍÌÏÎÎÌÍÍÍÌÌÌÌÍÌÏÍÌÍÌÌ; // 0x48
        public bool ÏÎÍÍÌÌÏÎÏÍÏÍÌÎÍÍÎÎÏÎÎÎÌ; // 0x4C
        public bool ÌÎÎÏÍÏÌÎÎÎÏÍÏÏÎÏÎÍÌÌÏÍÎ; // 0x4D
        public bool ÍÍÍÎÏÎÎÌÏÍÍÍÌÍÎÏÍÍÍÌÌÏÌ; // 0x4E
        public bool ÏÏÌÍÏÍÌÏÎÌÏÎÎÍÌÎÏÎÏÎÎÏÎ; // 0x4F
        public bool ÍÍÌÎÏÏÏÍÏÎÌÎÎÍÎÌÌÏÎÌÍÎÏ; // 0x50
        public bool ÍÌÍÎÏÌÏÍÌÌÎÍÎÎÌÍÌÍÌÎÎÏÎ; // 0x51
        public bool ÍÌÎÍÏÎÌÌÌÎÍÎÌÍÎÍÏÌÎÌÍÍÏ; // 0x52
        public bool ÎÎÍÌÏÌÌÌÎÍÏÌÏÏÎÍÏÌÍÌÍÌÏ; // 0x53
        public object ÌÍÌÎÏÌÍÎÌÎÍÌÍÏÎÍÌÎÎÌÍÏÌ; // 0x58
        public object ÌÎÏÍÏÎÎÎÌÎÏÍÌÍÍÏÎÏÎÏÎÍÌ; // 0x60
        public object ÍÏÎÍÌÏÍÎÌÏÎÎÎÌÌÍÏÏÎÏÎÌÎ; // 0x68
        public object ÏÌÎÌÏÍÍÌÍÍÏÎÎÎÍÎÏÎÌÏÌÍÌ; // 0x70
        public object ÎÌÎÍÎÎÍÏÏÎÌÎÎÍÍÏÌÎÏÎÎÌÏ; // 0x78
        public amut ÏÎÏÎÍÏÏÏÎÏÏÍÎÍÎÍÏÍÎÌÌÌÌ; // 0x80
        public amut ÏÍÍÌÍÍÍÌÎÌÏÏÌÍÎÌÌÍÏÌÏÍÎ; // 0x8C
        public amut ÎÌÌÎÏÌÌÌÎÍÏÏÍÏÌÏÏÎÏÎÏÌÌ; // 0x98
        public ColorScaleAndOffset ÌÏÏÏÌÍÌÎÏÌÏÍÎÌÍÌÌÏÏÍÏÎÎ; // 0xA4
        public amut ÌÌÌÏÏÍÏÏÍÍÎÏÌÌÌÌÏÎÌÏÎÏÎ; // 0xD0
        public amut ÌÏÌÌÏÌÏÎÍÏÌÏÌÏÌÏÎÎÏÎÏÌÌ; // 0xDC
        public float ÌÏÍÍÎÏÌÎÍÌÍÌÍÌÍÍÌÏÌÍÌÏÏ; // 0xE8
        public float ÏÏÎÏÎÏÍÎÌÎÍÍÎÌÍÍÍÏÏÎÎÏÏ; // 0xEC
        public float ÎÎÍÌÏÌÍÏÍÍÎÌÏÏÍÍÌÎÏÎÍÎÌ; // 0xF0
        public float ÏÍÎÌÎÍÎÌÎÍÌÌÍÌÎÌÌÎÏÏÏÌÎ; // 0xF4
        public float ÌÌÎÌÏÏÏÍÏÏÏÌÎÎÌÏÏÍÏÎÏÏÎ; // 0xF8
        public int ÏÍÏÍÏÏÎÍÏÍÎÎÏÏÎÏÏÎÍÎÌÌÍ; // 0xFC
        public int ÎÎÎÎÌÍÍÏÍÌÏÍÍÌÍÎÌÎÎÎÍÌÎ; // 0x100
        public int ÌÌÎÍÌÏÎÍÌÎÎÍÏÍÎÎÍÏÏÏÌÌÏ; // 0x104
        public bool ÌÏÍÎÌÌÎÎÌÎÎÏÏÏÌÌÏÎÍÏÎÍÏ; // 0x108
        public bool ÌÌÎÌÏÎÌÎÎÎÎÏÎÏÌÍÌÌÌÎÎÏÎ; // 0x109
        public amut ÍÏÍÍÏÍÌÌÏÎÍÎÎÏÏÌÎÌÌÎÍÌÎ; // 0x10C
        public bool ÍÎÎÏÎÏÌÏÍÌÏÍÌÏÎÍÎÏÌÎÍÍÌ; // 0x118
    ...
    {
        public ÍÏÏÏÏÌÌÍÌÏÏÏÌÏÎÍÌÌÏ maxNumDevices;
        public float currentNumDevices;
        public float maxStateSizeInBytes;
        public float currentStateSizeInBytes;
        public float currentControlCount;
        public float currentLayoutCount;
        public float totalEventBytes;
        public string totalEventCount;
        public object totalUpdateCount; // 0x20
        public object totalEventProcessingTime; // 0x24
        public object totalEventLagTime; // 0x28
        public ÎÎÏÎÏÌÍÌÏÎÌÏ averageEventBytesPerFrame; // 0x30
        public URA.DateTime<int,ÎÏÎÍÌÌÌÍÎ> averageProcessingTimePerEvent; // 0x38
        public URA.woDigitYearMax<moryFailure.priteMesh> averageLagTimePerEvent; // 0x40
        public URA.woDigitYearMax<int> ÎÎÏÎÏÍÌÎÍÎÎÌÎÏÏÎÍÌÍÏÎÎÏ; // 0x48
        public float ÎÍÎÏÎÏÌÍÏÌÏÎÌÍÎÎÌÍÎÏÏÌÏ; // 0x50
        public bool ÎÏÎÍÌÌÍÍÏÍÎÏÏÎÍÍÌÍÌÎÏÌÎ; // 0x54
        public amut ÎÌÏÍÌÌÍÎÏÌÏÎÌÏÍÎÎÌÌÍÌÎÌ; // 0x58
        public bool ÍÎÍÌÎÏÎÎÌÌÎÎÏÍÏÌÏÎÌÎÏÌÍ; // 0x64
        public bool ÏÌÎÍÎÍÏÎÏÏÎÌÏÎÍÌÎÌÏÏÌÌÍ; // 0x65
        public moryFailure.String,Valve.Newtonsoft.Json.Linq.JToken>>.IsReadOnly ÍÎÎÏÌÎÌÎÌÍÏÎÍÍÎÍÌÍÌÍÏÏÌ; // 0x68
        public URA.woDigitYearMax<moryFailure.priteMesh> ÍÍÍÎÌÏÎÎÍÏÍÎÌÍÏÌÍÏÌÏÌÏÎ; // 0x70
        public tionX ÌÌÏÎÌÌÌÌÍÌÌÍÍÏÏÌÍÍÏÌÍÍÎ; // 0x78
        public float ÎÏÌÍÎÎÎÌÍÌÍÌÍÍÎÍÎÍÍÌÎÍÏ; // 0x80
        public tionX ÏÍÏÌÎÎÎÍÎÎÏÍÌÍÍÏÎÏÍÌÎÌÌ; // 0x84
        public float ÏÏÍÌÎÍÏÌÌÎÏÏÌÏÌÌÎÌÌÏÌÏÍ; // 0x8C
        public ColorScaleAndOffset[] ÎÏÍÌÏÎÍÍÏÍÍÏÌÍÌÍÏÎÍÌÏÍÌ; // 0x8
        public tionX <ÏÎÌÍÍÎÍÍÎÍÌÌÌÍÎÍÍÎÍÌÌÏÍ>k__BackingField; // 0x90
        public float <ÎÎÎÌÏÍÍÍÏÌÏÌÌÏÍÎÍÌÏÎÎÎÎ>k__BackingField; // 0x98
        public ÎÌÍÏÏÌÍÏ ÍÌÎÎÎÌÏÎÏÎÎÎÏÎÎÏÏÏÌÎÎÌÍ; // 0xA0
        public tionX ÌÎÎÏÌÍÍÎÏÏÎÌÏÏÍÏÏÏÌÍÏÌÌ; // 0xA8
        public tionX ÌÏÌÎÌÏÏÍÎÍÍÏÌÎÏÌÍÍÎÎÏÏÎ; // 0xB0
        public float ÌÏÌÍÍÎÎÍÏÎÍÍÌÌÍÏÎÎÎÎÌÌÎ;
        public float ÌÍÎÌÎÌÌÌÎÌÏÎÍÎÏÎÏÏÏÌÌÌÍ;
