...
{
    public float hash;
    public float ÏÍÎÍÌÌÏÎÎÌÏÍÏÏÍÍÏÍÏÏÏÌÌ; // 0x70
    public float ÎÌÍÍÎÏÎÏÏÌÍÎÍÎÍÏÎÎÍÏÌÎÌ; // 0x74
    public re ÍÌÍÌÍÎÍÏÍÌÌÏÌÎÍÎÏÎÏÏÏÍÍ; // 0x78
...
{
    public tor_OverlaySettings.ckingToComponentRenderModel activeInput;
...
{
    public int <>1__state;
    public ArgCount.rializationSetValue<T1717598560> <>t__builder;
    public ialized.k<T1717598560> <>4__this;
    public tterServices<tCaMode<T1717598560>> <>u__1;
