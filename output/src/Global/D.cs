...
{
    public object applyButton; // 0x138
    public object closeButton; // 0x140
    public object cancelButton; // 0x148
    public object searchButton; // 0x150
    public object _backgroundClickHandler; // 0x158
    public ÍÏÎÍÌÍÌÎÌÏÌÍÏÍÌÏÎÎÎÎÏÏ _filterTitle; // 0x160
    public object _filterListContainer; // 0x168
    public dTag _stylesListBinding; // 0x170
    public dTag _activeStylesListBinding; // 0x178
    public ÍÍÏÌÎÎÎÌÍÍÍÎÍÏÎÌÍÏÏ>k__BackingField marketplaceToggle; // 0x180
    public ÍÍÏÌÎÎÎÌÍÍÍÎÍÏÎÌÍÏÏ>k__BackingField publicToggle; // 0x188
    public object _performanceDropdown; // 0x190
    public object _platformDropdown; // 0x198
    public ?<URA.woDigitYearMax<?>> ÎÍÏÍÏÌÏÍÏÍÏÎÌÏÎÎÎÎÌÏÏÏÏ; // 0x1A0
    public ?<URA.woDigitYearMax<?>> ÏÏÏÍÎÌÏÏÏÌÏÍÏÏÍÍÌÎÏÏÎÌÏ; // 0x1A8
    public URA.onsDepth<string> ÍÏÏÌÍÎÎÌÌÌÏÏÌÌÏÏÌÎÍÏÏÍÎ; // 0x1B0
    public ÎÌ.ers ÌÍÎÍÍÏÍÌÍÍÎÌÎÎÎÎÌÏÎÏÏÎÎ; // 0x1B8
    public ÎÌÍÏÏÌÍÏ ÌÎÏÍÍÏÌÎÎÎÏÌÎÌÌÍÏÏÎÎÏÎÏ; // 0x1C0
    public string ÎÍÍÌÌÌÍÍÎÎÍÎÌÌÍÌÌÎÍÏÍÍÎ; // 0x1C8
