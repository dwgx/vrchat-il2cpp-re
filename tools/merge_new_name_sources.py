...
def main():
    ...
    sources_direct = [
        ...
        ('llm_index_propagation',          'output/llm_index_propagation.json'),
        ('llm_rule_names',                 'output/llm_rule_names.json'),
        ('llm_string_id_names',            'output/llm_string_id_names.json'),
        ...
        ('llm_manual_names',               'output/llm_manual_names.json'),
        ('llm_oldname_in_strings',         'output/llm_oldname_in_strings.json'),
        ...
        ('llm_hexrays_names',              'output/llm_legacy_hexrays_names.json'),
