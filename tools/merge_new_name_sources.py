...
def main():
    ...
    sources_direct = [
        ...
        ('llm_index_propagation',          'output/claude_index_propagation.json'),
        ('llm_rule_names',                 'output/claude_rule_names.json'),
        ('llm_string_id_names',            'output/claude_string_id_names.json'),
        ...
        ('llm_manual_names',               'output/claude_manual_names.json'),
        ('llm_oldname_in_strings',         'output/claude_oldname_in_strings.json'),
        ...
        ('llm_hexrays_names',              'output/claude_hexrays_names.json'),
